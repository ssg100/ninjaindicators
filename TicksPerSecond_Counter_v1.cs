...
namespace NinjaTrader.Indicator
{
    ...
    public class TicksPerSecond_Counter_v1 : Indicator
    {
        #region Variables
...
namespace NinjaTrader.Indicator
{
    ...
    {
        private TicksPerSecond_Counter_v1[] cacheTicksPerSecond_Counter_v1 = null;

        private static TicksPerSecond_Counter_v1 checkTicksPerSecond_Counter_v1 = new TicksPerSecond_Counter_v1();

        /// <summary>
        /// Tick per Second
        /// </summary>
        /// <returns></returns>
        public TicksPerSecond_Counter_v1 TicksPerSecond_Counter_v1()
        {
            return TicksPerSecond_Counter_v1(Input);
        }
...
namespace NinjaTrader.MarketAnalyzer
{
    public partial class Column : ColumnBase
    {
        ...
        public Indicator.TicksPerSecond_Counter_v1 TicksPerSecond_Counter_v1()
        {
            return _indicator.TicksPerSecond_Counter_v1(Input);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Indicator.TicksPerSecond_Counter_v1 TicksPerSecond_Counter_v1(Data.IDataSeries input)
        {
            return _indicator.TicksPerSecond_Counter_v1(input);
        }
    }
