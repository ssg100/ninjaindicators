...
namespace NinjaTrader.Indicator
{
    ...
    public class ZZVPINcdf : Indicator
    {
        ...
        protected override void OnBarUpdate()
        {
			...
			else		// 			if( accumVol > volBucketSize )
				vpinDataseries.Set(VPINvalue);	
			...
			Print("SMA(vpinDataseries,10)[1] " + SMA(vpinDataseries,10)[1]);

			vpintemp=NORMDIST( (vpinDataseries[1]), SMA(vpinDataseries,100)[1], StdDev(vpinDataseries, 50)[1], true);
...
namespace NinjaTrader.Indicator
{
    ...
    {
        private ZZVPINcdf[] cacheZZVPINcdf = null;

        private static ZZVPINcdf checkZZVPINcdf = new ZZVPINcdf();

        /// <summary>
        /// VPIN indicator
        /// </summary>
        /// <returns></returns>
        public ZZVPINcdf ZZVPINcdf(int sampleSize, int volBucketSize)
        {
            return ZZVPINcdf(Input, sampleSize, volBucketSize);
        }
...
namespace NinjaTrader.MarketAnalyzer
{
    public partial class Column : ColumnBase
    {
        ...
        public Indicator.ZZVPINcdf ZZVPINcdf(int sampleSize, int volBucketSize)
        {
            return _indicator.ZZVPINcdf(Input, sampleSize, volBucketSize);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Indicator.ZZVPINcdf ZZVPINcdf(Data.IDataSeries input, int sampleSize, int volBucketSize)
        {
            return _indicator.ZZVPINcdf(input, sampleSize, volBucketSize);
        }
    }
