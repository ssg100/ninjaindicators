...
namespace NinjaTrader.Indicator
{
    ...
    /// </summary>
    [Description("The ZZZigZagDebug indicator shows trend lines filtering out changes below a defined level. ")]
    public class ZZZigZagDebug : Indicator
    {
        #region Variables
        ...
        {
            Add(new Plot(Color.Blue, PlotStyle.Line, "ZZZigZagDebug"));
        ...
        protected override void OnBarUpdate()
        {
			...
			zigZagHighSeries.Set(currentZigZagHigh);
			zigZagLowSeries.Set(currentZigZagLow);
			Print( "Time = " + Time[0].Hour + "  " + Time[0].Minute + " Value = " + zigZagHighSeries[0] + "  " + Value[0]);
		...
		/// <summary>
		/// Gets the ZZZigZagDebug high points.
		/// </summary>
		[Browsable(false)]
		[XmlIgnore()]
		...
		/// <summary>
		/// Gets the ZZZigZagDebug low points.
		/// </summary>
		[Browsable(false)]
		[XmlIgnore()]
		...
		public override void Plot(Graphics graphics, Rectangle bounds, double min, double max)
		{
			...
			if (!linePlotted)
				DrawTextFixed("ZigZagErrorMsg", "ZZZigZagDebug can't plot any values since the deviation value is too large. Please reduce it.", TextPosition.BottomRight);
		}
...
namespace NinjaTrader.Indicator
{
    ...
    {
        private ZZZigZagDebug[] cacheZZZigZagDebug = null;

        private static ZZZigZagDebug checkZZZigZagDebug = new ZZZigZagDebug();

        /// <summary>
        /// The ZZZigZagDebug indicator shows trend lines filtering out changes below a defined level. 
        /// </summary>
        /// <returns></returns>
        public ZZZigZagDebug ZZZigZagDebug(DeviationType deviationType, double deviationValue, bool useHighLow)
        {
            return ZZZigZagDebug(Input, deviationType, deviationValue, useHighLow);
        }
